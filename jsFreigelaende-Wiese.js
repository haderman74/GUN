function calc() 
	...
	else if (tmpFlaechePlatzmiete < 200)
		{
		tmpKostenPlatzmiete = tmpFlaechePlatzmiete * 4.90;
		$('KostenPlatzmiete').value = Runden2Dezimal(tmpKostenPlatzmiete);
		}
	else if (tmpFlaechePlatzmiete < 300)
		{
		tmpKostenPlatzmiete = tmpFlaechePlatzmiete * 3.90;
		$('KostenPlatzmiete').value = Runden2Dezimal(tmpKostenPlatzmiete);
		}
	else
		{
		tmpKostenPlatzmiete = tmpFlaechePlatzmiete * 3.30;
		$('KostenPlatzmiete').value = Runden2Dezimal(tmpKostenPlatzmiete);
		}
	//Kosten für Strom
	...
	//Gesamtkosten ermitteln
		...
		tmpKostenGesamtohne = tmpKostenPlatzmiete + tmpKostenStrom + tmpKostenWasser + tmpKostenTransparent + tmpWerbekostenpflichtbeitrag + tmpNachlassTransparent + tmpKostenWerbeeinschaltung;
